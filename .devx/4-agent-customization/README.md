<div class="m7-hero" data-eyebrow="MODULE 04 / AGENT CUSTOMIZATION" data-title="Agent Customization Workshop"></div>
...
- A **synthetic data generation pipeline** for training data using NeMo Data Designer
- A **reward function** for verifiable CLI command correctness
