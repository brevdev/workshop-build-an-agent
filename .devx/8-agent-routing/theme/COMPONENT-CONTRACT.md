...
```html
<div class="dx-hero" data-eyebrow="MODULE 08 / AGENT ROUTING" data-title="Same agent. Different model per call." data-sub="One-sentence framing in plain text - no quotes or braces." data-meta="DURATION::2-3 hrs|EXERCISES::5|MODEL::Nemotron"></div>
```
