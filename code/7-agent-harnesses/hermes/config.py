...
This file ships complete — there are no exercises in it. Everything is
overridable by an environment variable so Exercise 5 can repoint Hermes at the
sandbox gateway without editing code.
"""
